...
import { faStar, faEyeSlash, faTrash, faFaceSadCry } from "@fortawesome/free-solid-svg-icons";
...
export default function Podcast() {
  ...
  const [searchedEpisodes, setSearchedEpisodes] = useState<Episode[] | null>(null);
  ...
  return (
    <>
      ...
      <Card className="flex flex-col items-center mt-5 rounded-sm h-screen">
        ...
        {searchedEpisodes !== null && searchedEpisodes.length === 0 && (
                ...
                <ItemTitle>
                  ...
                  <div>
                    ...
                    <p
                      ...
                      onClick={() =>
                        window.open(
                          "https://docs.google.com/forms/d/e/1FAIpQLSePK2Q0wuY3q28Ek9UPIeBpenYY3EMg6gEqtZmuGxKx16xZwA/viewform?usp=header"
                        )
                      }
                    >
                      Report missing?
